...
public class ImageAdapter extends BaseAdapter {
    ...
    public int[] imageArray = {
            ...
            R.drawable.pic29,R.drawable.pic30,R.drawable.pic31,R.drawable.pic32,R.drawable.pic33,R.drawable.pic34,R.drawable.pic35,
            R.drawable.pic36,R.drawable.pic37,R.drawable.pic38,R.drawable.pic39,R.drawable.pic40,R.drawable.pic41,R.drawable.pic42
    };
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageView.setLayoutParams(new GridView.LayoutParams(260,270));
        return imageView;
    }
}
